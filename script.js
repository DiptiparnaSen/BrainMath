...
const invalidInputImage = document.getElementById("invalidInputImage");
const resultDisplay = document.querySelector(".result-display");
const resultValue = document.getElementById("resultValue");
const overflowResultImage = document.getElementById("overflowResultImage");
...
function showInvalidInputImage() {
  enteredDisplay.classList.add("image-mode");
  enteredValue.hidden = true;
  invalidInputImage.hidden = false;
}

function hideInvalidInputImage() {
  enteredDisplay.classList.remove("image-mode");
  enteredValue.hidden = false;
  invalidInputImage.hidden = true;
}

function showOverflowResultImage() {
  resultDisplay.classList.add("image-mode");
  resultValue.hidden = true;
  overflowResultImage.hidden = false;
}

function hideOverflowResultImage() {
  resultDisplay.classList.remove("image-mode");
  resultValue.hidden = false;
  overflowResultImage.hidden = true;
}
...
function syncEnteredFromInput(rawValue) {
  ...
  showInvalidInputImage();
}

function refreshInputState() {
  const rawValue = numberInput.value;
  hideOverflowResultImage();
